...
public extension JBLayouting {
    ...
    fileprivate func cleanView() {
        if self.titleLabel!.isDescendant(of: self) {
            self.titleLabel!.removeFromSuperview()
        }
        
        if !self.imageView!.isDescendant(of: self) {
     ...
     */
    fileprivate func layoutForTop(fromImageView imageView: UIImageView) -> (CGRect, CGRect) {
    ...
    /**
     ...
     - returns: a tuple containing the frames of both the image and the label
     */
    fileprivate func layoutForBottom(fromImageView imageView: UIImageView) -> (CGRect, CGRect) {
        let imageViewFrame = CGRect(
            x: self.frame.width/2 - imageView.frame.width/2,
    ...
    /**
     ...
     - returns: a tuple containing the frames of both the image and the label
     */
    fileprivate func layoutForLeft(fromImageView imageView: UIImageView) -> (CGRect, CGRect) {
        let imageViewFrame = CGRect(
            x: 0 + self.customPadding,
    ...
    /**
     ...
     - returns: a tuple containing the frames of both the image and the label
     */
    fileprivate func layoutForRight(fromImageView imageView: UIImageView) -> (CGRect, CGRect) {
        let imageViewFrame = CGRect(
     ...
     */
    fileprivate func setupImageView(withFrame frame: CGRect) {
        ...
        if self.image != nil {
            ...
            case .original:
                self.imageView?.image = self.image!.withRenderingMode(.alwaysOriginal)
            case .template:
     ...
     */
    fileprivate func setupLabel(withFrame frame: CGRect) {
